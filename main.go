...
var (
	...
	defaultASNs    = cli.Int64Slice{cip.ASN_TENCENT_CN, cip.ASN_ALIBABA_CN, cip.ASN_HINET, cip.ASN_HKBN, cip.ASN_NEWTT, cip.ASN_UHGL, cip.ASN_BCPL_SG, 136038} // cip.ASN_MICROSOFT
)
